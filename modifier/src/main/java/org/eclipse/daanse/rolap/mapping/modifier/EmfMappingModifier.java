...
import org.eclipse.daanse.emf.model.rolapmapping.AccessMemberGrant;
...
import org.eclipse.daanse.emf.model.rolapmapping.DrillThroughAction;
import org.eclipse.daanse.emf.model.rolapmapping.DrillThroughAttribute;
...
import org.eclipse.daanse.emf.model.rolapmapping.Translation;
...
public class EmfMappingModifier extends AbstractMappingModifier {
    ...
    protected CatalogMapping createCatalog(
        ...
        //??
        catalog.getDbschemas().addAll((Collection<? extends org.eclipse.daanse.emf.model.rdbstructure.DatabaseSchema>) dbschemas);
        return catalog;
    }
    ...
    protected CalculatedMemberMapping createCalculatedMember(
        ...
        calculatedMember.setDimensionConector((DimensionConnector) dimensionConector);
